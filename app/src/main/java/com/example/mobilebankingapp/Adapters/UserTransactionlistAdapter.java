...
import com.example.mobilebankingapp.UserData;

import java.util.ArrayList;

public class UserTransactionlistAdapter extends RecyclerView.Adapter<UserTransactionlistAdapter.ViewHolder> {

    private ArrayList<User> userArrayList;

    public UserTransactionlistAdapter(Context context, ArrayList<User> list) {
        userArrayList = list;
    }
    ...
    @NonNull
    @Override
    public UserTransactionlistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from (viewGroup.getContext()).inflate(R.layout.user_list_item, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UserTransactionlistAdapter.ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
